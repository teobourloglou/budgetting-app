package com.example.budgettingapp.ui.method
        ...
        ScreenContent(
            ...
            )
            {
                ...
                Row (
                    ...
                    Button(
                        onClick = {
                            navController.navigate(route = Screen.MethodEntry.route)
                        },
                        colors = ButtonDefaults.buttonColors(colorScheme.tertiary),
                        modifier = modifier.weight(1f)
                    ) {
                        Text(
                            text = stringResource(R.string.add_method),
                    ...
                    LazyColumn(
                        ...
                        items(state.methods) { method ->
                            Row(
                                ...
                                IconButton(onClick = {
                                    onEvent(ExpenseEvent.DeleteMethod(method))
                                }) {
                                    Icon(
                        ...
                        Column(
                            ...
                            Row(
                                ...
                                Button(
                                    modifier = modifier.weight(1f),
                                    onClick = {
                                        val newMethod = Method(methodId, payment)
                                        onEvent(ExpenseEvent.UpdateMethod(newMethod))
